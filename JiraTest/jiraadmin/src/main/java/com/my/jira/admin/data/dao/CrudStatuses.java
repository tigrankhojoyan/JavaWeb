...
public enum CrudStatuses {
    ...
    USER_DELETE_NON_EXISTING_USER("nonExistingUser", "The specified user does not exist."),
    USER_DELETE_FAIL("userDeleteFailed", "Failed to delete the specified user."),
    TASK_DELETE_NON_EXISTING_TASK("deleteNonExistingTask", "The specified task does not exist."),
    TASK_DELETE_SUCCESS("taskDeleted", "The task has been deleted successfully."),
    TASK_DELETE_FAIL("taskDeleteFailed", "Failed to delete the specified task."),
